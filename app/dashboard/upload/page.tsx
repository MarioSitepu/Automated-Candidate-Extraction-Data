...
import { uploadAndExtract } from "../../actions/extract";
    ...
    <div className="flex-1 flex flex-col h-full bg-[#F8FAFC]">
      ...
      <header className="px-8 py-6 flex items-center justify-between bg-[#F8FAFC]">
        ...
        <div className="flex items-center space-x-3">
          <button 
            onClick={() => { setFile(null); setTranscript([]); }}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-12 gap-4">
                  <div className="col-span-6 space-y-1.5">
                    ...
                    <input type="text" placeholder="Generated by AI..." className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-teal-500" />
                  </div>
                  <div className="col-span-2 space-y-1.5">
                    <label className="text-xs font-bold text-gray-600">Umur</label>
                    <input type="text" placeholder="AI..." className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-teal-500" />
                  </div>
